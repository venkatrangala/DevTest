...
export class CustomerService {
  ...
  public GetCustomerType(): Observable<string[]> {
    return this.httpClient.get<string[]>('http://localhost:63235/customer/CustomerType');
  }
  // public CreateCustomer(customer: CustomerModel): Promise<object> {
  //   return this.httpClient.post<CustomerModel>('http://localhost:63235/customer', customer).toPromise();
  // }
  public CreateCustomer(customer: CustomerModel): Promise<object> {
