...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20210423101700_TableRelationChanges")]
    partial class TableRelationChanges
    {
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            JobId = 1,
                            Engineer = "Test",
                            When = new DateTime(2021, 4, 23, 11, 16, 59, 291, DateTimeKind.Local).AddTicks(2815)
                        });
                });
